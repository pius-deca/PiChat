...
public class CommentController {
  ...
  public ResponseEntity<ApiResponse<Comment>> comment(@PathVariable(name = "postId") String post,
  ...
  public ResponseEntity<ApiResponse<Integer>> countComments(@PathVariable(name = "postId") String post,
